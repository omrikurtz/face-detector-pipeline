...
We chain together different pipeline objects just like we do on Unix. Isn't it fun?!
...
class Pipeline(object):
    ...
    def __or__(self, other):
        ...
        For instance, lets say we have 2 phases of processings, and a database insert, we can write it as:
